...
int main( int argc, char* argv[] ) {
	if ( argc < 3 ) {
		Log( "Bin2CSharp - Convert a Binary file to a C# file\n" );
		Log( "  Usage: Bin2CSharp In.bin Out.c PREFIX SUFFIX NAMESPACE CLASS\n" );
		return -1;
	}
	...
	Out << "// " << Symbol << " - Generated by Bin2CSharp //" << endl;
	if ( Namespace != "" ) {
