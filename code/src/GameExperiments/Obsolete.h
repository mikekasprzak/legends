...
//		gelDrawCircle( PointA, Real(2), GEL_RGB_DEFAULT );
//		gelDrawCircle( PointB, Real(2), GEL_RGB_DEFAULT );
//		gelDrawCircle( CenterPoint, Real(2), GEL_RGB_DEFAULT );
//		gelDrawCircle( CenterPoint2, Real(2), GEL_RGB_DEFAULT );
	}
	*/
	// -- //