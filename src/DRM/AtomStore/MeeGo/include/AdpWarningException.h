...
#ifndef ADPWARNINGEXCEPTION_H_
#define ADPWARNINGEXCEPTION_H_
...
namespace com {
	namespace intel {
		namespace adp {
			...
			class AdpWarningException: public AdpException 
			{
			public:
				/**
				 * A constructor that takes the message and code of the exception
				 */
				AdpWarningException(string message, long code = 0) throw();
			};
		}
	}
}
